...
const onButtonPress = tag => {
    ...
    switch (tag) {
        case tags.YOU:
            ...
            queDelay(2000);
            queSpacer();
            TypeOutParagraph(aboutMe6, 'about-me-6');
            queDelay(600);
...
const aboutMe3 = `There's a lot of things I love, especially sports. `;
const aboutMe4 = `Any kind of sports really. `;
const aboutMe5 = `Mix that up with concepts, designing and talking ideas and you describe my perfect day.`;
const aboutMe6 = `My schedule is often full of things to do, `;
const aboutMe7 = `planned into the minutes. `;
const aboutMe8 = `But at the same time, `;
const aboutMe9 = ` I always make sure to make time for my friends and to get out in nature and reed a good book.`;
